      ...
      <div class="p-5 rounded-xl bg-white max-w-2xl flex-1 text-center border shadow-2xl">
        <div class="grid grid-cols-3 place-items-center ">
          ...
          <div class="col-span-2">
            <input type="text" class="border border-black p-2 rounded-lg mb-4 w-96 " v-model="form.fileNumber"
          ...
          <div class="col-span-2">
            <input type="text" class="border border-black p-2 rounded-lg mb-4 w-96" v-model="form.subject"
          ...
          <div class="col-span-2">
            <input type="text" class="border border-black p-2 rounded-lg mb-4 w-96" v-model="form.fromWhomReceived"
          ...
          <div class="col-span-2">
            <select class="w-96 border border-black p-2 rounded-lg mb-4" v-model="form.areaOfFiling"
          ...
          <div class="col-span-2">
            <input type="date" class="border border-black p-2 rounded-lg mb-4 " v-model="form.dateOfLetters"
          ...
          <div class="col-span-2">
            <input type="date" class="border border-black p-2 rounded-lg mb-4 " v-model="form.dateOfReceipt"
          ...
          <div class="col-span-2">
            <textarea type="text" class="border border-black p-2 rounded-lg mb-4 w-96 h-20" v-model="form.remarksComments"
              aria-describedby="emailHelp" name="remarksComments" />
          </div>
        </div>
        <div class="flex justify-around">
          <button type="submit" :disabled="isLoading"
            class="bg-red-500 hover:bg-red-600 transition-all duration-200  text-white rounded-lg p-2" :class="{
              'opcatiy-20 cursor-not-allowed': isLoading
            }">
            <NuxtLink to="/">Cancel</NuxtLink>
          </button>

          <button @click="handleInfoSubmit()" type="submit" :disabled="isLoading"
            class="bg-blue-500 hover:bg-blue-600 transition-all duration-200  text-white rounded-lg p-2" :class="{
              'opcatiy-20 cursor-not-allowed': isLoading
            }">
            Submit
          </button>
